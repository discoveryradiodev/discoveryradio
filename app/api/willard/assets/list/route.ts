  ...
  try {
    ...
    const assets: WillardAsset[] = response.blobs.map((blob) => {
      ...
      return {
        ...
        url: manifestEntry?.optimizedUrl ?? manifestEntry?.optimizedPath ?? blob.url,
        pathname,
        ...
        size: blob.size,
        originalWidth: manifestEntry?.originalWidth,
        originalHeight: manifestEntry?.originalHeight,
        originalSize: manifestEntry?.originalSize,
        optimizedWidth: manifestEntry?.optimizedWidth,
        optimizedHeight: manifestEntry?.optimizedHeight,
        optimizedSize: manifestEntry?.optimizedSize,
        optimizedPath: manifestEntry?.optimizedPath,
        optimizedUrl: manifestEntry?.optimizedUrl,
        thumbnailPath: manifestEntry?.thumbnailPath,
        thumbnailUrl: manifestEntry?.thumbnailUrl,
        oversizedOriginal: manifestEntry?.oversizedOriginal,
        originalStorage: manifestEntry?.originalStorage,
